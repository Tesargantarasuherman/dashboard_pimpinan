...
class SaktiController extends Controller
{
    ...
    public function getDistrict(Request $request){
        ...
        curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://bandung.sakti112.id/api/services/get-district',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
    ...
    public function getSubdistrict(Request $request){
        ...
        curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://bandung.sakti112.id/api/services/get-subdistrict?districtid=' . $districtid,
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
    ...
    public function ticketStatsToday(Request $request){
        $curl = curl_init();
    ...
    public function category(Request $request){
        ...
        curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://bandung.sakti112.id/api/services/category',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
    ...
    public function categoryToday(Request $request){
        $curl = curl_init();

        curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://bandung.sakti112.id/api/services/category-today',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
    ...
    public function districtToday(Request $request){
        $curl = curl_init();

        curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://bandung.sakti112.id/api/services/district-today',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
    ...
    public function opdToday(Request $request){
        $curl = curl_init();

        curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://bandung.sakti112.id/api/services/opd-today',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
    ...
    public function telephonyStatsToday(Request $request){
        $curl = curl_init();

        curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://bandung.sakti112.id/api/services/telephony-stats-today',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
    ...
    public function getCategoryToday(Request $request){
        $curl = curl_init();
