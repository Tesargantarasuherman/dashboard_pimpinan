...
<script>
    function getVaksin() {
        $.ajax({
            ...
            success: function (res) {
                ...
                const result_vaksin_petugas_publik0 = Math.round((res.data[0].vaksin_petugas_publik / res
                    .sasaran_petugas_publik) * 100)
                const result_vaksin_lansia0 = Math.round((res.data[0].vaksin_lansia / res.sasaran_lansia) *
                    100)
                const result_vaksin_masyarakat0 = Math.round((res.data[0].vaksin_masyarakat / res
                    .sasaran_masyarakat) * 100)
                const result_vaksin_remaja0 = Math.round((res.data[0].vaksin_remaja / res.sasaran_remaja) *
                    100)
                const result_vaksin_anak0 = Math.round((res.data[0].vaksin_anak / res.sasaran_anak) * 100)
                const result_vaksin_gotong_royong0 = Math.ceil((res.data[0].vaksin_gotong_royong / res
                    .sasaran_gotong_royong) * 100)
                ...
                const result_vaksin_petugas_publik1 = Math.round((res.data[1].vaksin_petugas_publik / res
                    .sasaran_petugas_publik) * 100)
                const result_vaksin_lansia1 = Math.round((res.data[1].vaksin_lansia / res.sasaran_lansia) *
                    100)
                const result_vaksin_masyarakat1 = Math.round((res.data[1].vaksin_masyarakat / res
                    .sasaran_masyarakat) * 100)
                const result_vaksin_remaja1 = Math.round((res.data[1].vaksin_remaja / res.sasaran_remaja) *
                    100)
                const result_vaksin_anak1 = Math.round((res.data[1].vaksin_anak / res.sasaran_anak) * 100)
                const result_vaksin_gotong_royong1 = Math.ceil((res.data[1].vaksin_gotong_royong / res
                    .sasaran_gotong_royong) * 100)
                ...
                const result_vaksin_petugas_publik2 = Math.round((res.data[2].vaksin_petugas_publik / res
                    .sasaran_petugas_publik) * 100)
                const result_vaksin_lansia2 = Math.round((res.data[2].vaksin_lansia / res.sasaran_lansia) *
                    100)
                const result_vaksin_masyarakat2 = Math.round((res.data[2].vaksin_masyarakat / res
                    .sasaran_masyarakat) * 100)
                const result_vaksin_remaja2 = Math.round((res.data[2].vaksin_remaja / res.sasaran_remaja) *
                    100)
                const result_vaksin_anak2 = Math.round((res.data[2].vaksin_anak / res.sasaran_anak) * 100)
                const result_vaksin_gotong_royong2 = Math.ceil((res.data[2].vaksin_gotong_royong / res
                    .sasaran_gotong_royong) * 100)
                ...
                setVaksin(
                    result_nakes0,
                    result_vaksin_petugas_publik0, 
                    result_vaksin_lansia0,
                    result_vaksin_masyarakat0, 
                    result_vaksin_remaja0, 
                    result_vaksin_anak0,
                    result_vaksin_gotong_royong0,

                    result_nakes1,
                    result_vaksin_petugas_publik1, 
                    result_vaksin_lansia1,
                    result_vaksin_masyarakat1, 
                    result_vaksin_remaja1, 
                    result_vaksin_anak1,
                    result_vaksin_gotong_royong1,
                    
                    result_nakes2,
                    result_vaksin_petugas_publik2, 
                    result_vaksin_lansia2,
                    result_vaksin_masyarakat2, 
                    result_vaksin_remaja2, 
                    result_vaksin_anak2,
                    result_vaksin_gotong_royong2,
                )
    ...
    function setVaksin(
        ...
        vaksin_nakes2, 
        vaksin_petugas_publik2, 
        vaksin_lansia2, 
        vaksin_masyarakat2, 
        vaksin_remaja2,
        vaksin_anak2, 
        vaksin_gotong_royong2,

        vaksin_nakes3, 
        vaksin_petugas_publik3, 
        vaksin_lansia3, 
        vaksin_masyarakat3, 
        vaksin_remaja3,
        vaksin_anak3, 
        vaksin_gotong_royong3,
        ...
        Highcharts.chart('chart_vaksin2', {
            ...
            title: {
                align: 'left',
                text: 'Grafik Ketercapaian Vaksin Kota Bandung'
            },
            subtitle: {
                align: 'left',
                text: 'Source:Dinas Kesehatan Kota Bandung '
            },
            accessibility: {
                announceNewData: {
                    enabled: true
            ...
            series: [
                {
                    ...
                    data: [
                        vaksin_nakes,
                        vaksin_petugas_publik,
                        vaksin_lansia, vaksin_masyarakat, vaksin_remaja,
                        vaksin_anak,
                        vaksin_gotong_royong,
                    ]
                },
                {
                    ...
                    data: [
                        vaksin_nakes2,
                        vaksin_petugas_publik2,
                        vaksin_lansia2, vaksin_masyarakat2, vaksin_remaja2,
                        vaksin_anak2,
                        vaksin_gotong_royong2,
                    ]
                },
                {
                    ...
                    data: [
                        vaksin_nakes3,
                        vaksin_petugas_publik3,
                        vaksin_lansia3, vaksin_masyarakat3, vaksin_remaja3,
                        vaksin_anak3,
                        vaksin_gotong_royong3,
                    ]
                },
