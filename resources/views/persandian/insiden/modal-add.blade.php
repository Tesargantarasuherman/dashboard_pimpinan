    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class="modal-title h4" style="font-size: 12px; font-weight: bold; text-transform: uppercase;" id="addModal">Tambah Data Insiden Siber</div>
            ...
            <form class="addModal" method="POST" action="{{ route('pentest.create') }}"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="name">Alamat Website</label>
                    ...
                    <div class="form-group">
                        <label for="name">Tanggal Pentest</label>
