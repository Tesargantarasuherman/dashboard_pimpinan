...
@foreach ($getMenara as $menara)
    <div class="modal fade" id="edit-modal-{{ $menara->id }}" tabindex="-1" role="dialog" aria-labelledby="editModal"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="modal-title h4" style="font-size: 12px; font-weight: bold; text-transform: uppercase;"
                        id="editModal">Edit Status Menara Telekomunikasi</div>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form class="editModal" method="POST" action="{{ route('menara.update', $menara->id) }}"
                    ...
                    {{-- <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user" name="lokasi"
                                placeholder="{{ __('lokasi') }}" value="{{ old('lokasi', $menara->lokasi) }}"
                                required autofocus>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user" name="latitude"
                                placeholder="{{ __('latitude') }}" value="{{ old('latitude', $menara->latitude) }}"
                                required autofocus>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user" name="longitude"
                                placeholder="{{ __('longitude') }}" value="{{ old('longitude', $menara->longitude) }}"
                                required autofocus>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user" name="dinas"
                                placeholder="{{ __('dinas') }}" value="{{ old('dinas', $menara->dinas) }}" required
                                autofocus>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user" name="vendor"
                                placeholder="{{ __('vendor') }}" value="{{ old('vendor', $menara->vendor) }}" required
                                autofocus>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user" name="link streaming"
                                ...
                                value="{{ old('link streaming', $menara->link_stream) }}" required autofocus>
                        </div>
                    ...
                    <div class="modal-body">
                        <select class="form-control" id="status" name="status" value="{{ old('status') }}"
                            ...
                            <option value="0" {{ $menara->status == 0 ? 'selected' : '' }}>OFF</option>
                            <option value="1" {{ $menara->status != 0 ? 'selected' : '' }}>ON</option>
                        </select>
                    </div>
