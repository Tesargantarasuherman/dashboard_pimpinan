   ...
   <script>
    ...
    $(document).ready(function(){
            $.getJSON('map',function(data){
                ...
                L.marker([data[i].latitude,data[i].longitude]).addTo(map).bindPopup('<video id="my-video" class="video-js" controls preload="auto" width="640" data-setup="{}"><source src="https://pelindung.bandung.go.id:3443/video/DAHUA/Pusda.m3u8" type="application/vnd.apple.mpegurl" /></video>').openPopup();
                });
            });
        });
    })
